...
class HomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('gambar') != null) {
            if (Auth::user()->gambar != null) {
                File::delete('images/avatar/' . Auth::user()->gambar);
            }
            ...
            $nameFile = $name . '.' . $eks;
            $request->file('gambar')->move(public_path('images/avatar'), $nameFile);
        } else {
            $nameFile = Auth::user()->gambar;
        }
        ...
        return redirect()->route('home.index')->with(['message' => 'Data Berhasil di update']);
    }
    ...
    public function permissionSakit(Attendance $attendance)
    {
        // return $attendance;
        return view('home.permissionFormSakit', [
            "title" => "Form Permintaan Izin Sakit",
            "attendance" => $attendance
        ]);
    }
    public function permissionCuti(Attendance $attendance)
    {
        return view('home.permissionFormCuti', [
            "title" => "Form Permintaan Izin Cuti",
            "attendance" => $attendance
        ]);
    }
