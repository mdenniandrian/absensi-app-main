...
Route::middleware('auth')->group(function () {
    Route::middleware('role:admin,operator')->group(function () {
        ...
        // problems
        // Route::resource('/problem', ProblemController::class)->only(['index']);
        // Route::get('/problem/create', [ProblemController::class, 'create'])->name('problem.create');
        // Route::post('/problem/save', [ProblemController::class, 'saveform']);
        // Route::put('/problem/update/{id}', [ProblemController::class, 'update']);
        // Route::get('/problem/edit/{id}', [ProblemController::class, 'edit']);
        // Route::get('/problem/delete/{id}', [ProblemController::class, 'delete']);
        // presences (kehadiran)
    ...
    Route::middleware('role:user')->name('home.')->group(function () {
        ...
        Route::get('/absensi/{attendance}/permission/sakit', [HomeController::class, 'permissionSakit'])->name('permissionSakit');
        Route::get('/absensi/{attendance}/permission/cuti', [HomeController::class, 'permissionCuti'])->name('permissionCuti');
    });
...
Route::middleware('auth')->group(function () {
    // ... Bagian lain dari rute yang tidak berubah ...

    // Move route definitions for 'ProblemController' outside the 'admin,operator' middleware group
    Route::resource('/problem', ProblemController::class)->only(['index']);
    Route::get('/problem/create', [ProblemController::class, 'create'])->name('problem.create');
    Route::post('/problem/save', [ProblemController::class, 'saveform']);
    Route::put('/problem/update/{id}', [ProblemController::class, 'update']);
    Route::get('/problem/edit/{id}', [ProblemController::class, 'edit']);
    Route::get('/problem/delete/{id}', [ProblemController::class, 'delete']);
    // ... Rute lain yang ingin Anda tambahkan di sini ...
});
