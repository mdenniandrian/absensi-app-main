    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn("presence_out_time", function (Presence $model) {
                return $model->presence_out_time ?? '<span class="badge text-bg-danger">Belum Absensi Pulang</span>';
            })
            ->addColumn("is_permission", function (Presence $model) {
                $jenisIzin = $model->permisson->jenis_izin ?? null;
                if ($jenisIzin == 'cuti') {
                    $badge = '<span class="badge text-bg-warning">Izin Cuti</span>';
                } elseif ($jenisIzin == 'sakit') {
                    $badge = '<span class="badge text-bg-warning">Izin Sakit</span>';
                } elseif ($jenisIzin == 'izin') {
                    $badge = '<span class="badge text-bg-warning">Izin Biasa</span>';
                } else {
                    $badge = '<span class="badge text-bg-success">Hadir</span>';
                }

                return $badge;
            })
            ->addColumn('created_at')
            ->addColumn('created_at_formatted', function (Presence $model) {
