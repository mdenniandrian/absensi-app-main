            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul>
                            <li>Jenis Izin: <span>{{ $permission->jenis_izin }}</span></li>
                            <li>Judul Izin : <span id="permission-title"></span></li>
                            <li>Keterangan Izin : <p id="permission-description"></p>
                            </li>
                            @if ($permission->jenis_izin === 'sakit' || $permission->jenis_izin === 'cuti')
                                <li>Start Date : <p>{{ $permission->mulai_izin }}</p>
                                <li>End Date : <p>{{ $permission->akhir_izin }}</p>
                            @endif
                            @if ($permission->jenis_izin === 'sakit' || $permission->jenis_izin === 'cuti')
                                <li>Bukti : <img src="{{ asset('storage/' . $permission->uploadFile) }}" alt="Bukti Izin"
                                        width="100%"></li>
                            @endif
