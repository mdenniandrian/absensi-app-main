        ...
        @foreach ($employees as $i => $employee)
            <div class="mb-3">
                <div class="w-100">
                    ...
                    <div class="mb-3">
                        <x-form-label id="username{{ $i }}"
                            label='Username Karyawaan {{ $i + 1 }}' />
                        <x-form-input id="username{{ $i }}" name="username{{ $i }}"
                            type="text" wire:model.defer="employees.{{ $i }}.username"
                    ...
                    <div class="mb-3">
                        <x-form-label id="password{{ $i }}"
                            label='Password Karyawaan {{ $i + 1 }} (default: "123" jika tidak diisi)'
                            required="false" />
                    ...
                    <div class="mb-3">
                        <x-form-label id="position_id{{ $i }}"
                            label='Jabatan / Posisi Karyawaan {{ $i + 1 }}' />
